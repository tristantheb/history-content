...
import AsyncTable from '../AsyncTable.jsx';
import { useComputedRows } from '../../workers/useComputedRows.js';
import { usePopularityWorker } from '../../workers/usePopularityWorker.js';
import { useDisplayRows } from '../../workers/useDisplayRows.jsx';
import { usePaginatedWorker } from '../../workers/usePaginatedWorker.js';

export default function TableContainer({ original = [], localized = [], popularityCsv = '', rowsPerPage = 50 }) {
