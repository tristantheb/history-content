  ...
  return (
    <div className="flex gap-2 items-center justify-center md:justify-start">
      <button
        ...
        className="p-2 rounded-full bg-slate-700 hover:bg-blue-700 text-white font-semibold transition disabled:opacity-50 hover:cursor-pointer disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-400"
      >
